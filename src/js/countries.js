/* ── ISO 3166-1 ALPHA-2 COUNTRY DATABASE ─────────────────────── */
...
export function getCountryByCode(code) {
  return ISO_COUNTRIES.find(c => c.code === code);
}

export function getCountriesByRegion(region) {
  return ISO_COUNTRIES.filter(c => c.region === region);
}

export function getAllRegions() {
  return [...new Set(ISO_COUNTRIES.map(c => c.region))].sort();
}
